...
class BaseEngine :
    ...
    public FilterPoints
    // This object can also be used as a filter for points - e.g. restricting to only drawing inside update region
{
public:
...
public:
    ...
    virtual void virtTouchEvent(int type, int timestamp, SDL_TouchID touchID, SDL_FingerID fingerID, float x, float y,
...
public:
    ...
    void notifyTopObjectAboutMouseClick(bool bNotifyObjectsYesNo) {
        m_bNotifyTopObjectAboutMouse = bNotifyObjectsYesNo;
    }

    void notifyBottomObjectAboutMouseClick(bool bNotifyObjectsYesNo) {
        m_bNotifyBottomObjectAboutMouse = bNotifyObjectsYesNo;
    }
...
public:
    ...
    */
    ...
    } // Just before objects update, only if they should update - i.e. not every pass
    virtual void virtMainLoopDoAfterUpdate() {
    } // Just after objects update, only if they should update - i.e. not every pass
...
public:
    ...
    */
    ...
    virtual void fillBackground(unsigned int uiPixelColour) { m_pBackgroundSurface->fillSurface(uiPixelColour); }
    ...
    */
    ...
    x and y are REAL coordinates on the screen, so are NOT affected by scrolling or zooming.
    */
    static void copyRectangleBetweenSurfaces(DrawingSurface* from, DrawingSurface* to, int iRealPixelX, int iRealPixelY,
    ...
    */
    ...
    void setForegroundPixel(int iVirtualX, int iVirtualY, unsigned int uiColour) {
    ...
    void setBackgroundPixel(int iVirtualX, int iVirtualY, unsigned int uiColour) {
    ...
    void drawForegroundThickLine(int iVirtualX1, int iVirtualY1, int iVirtualX2, int iVirtualY2, unsigned int uiColour,
                                 int iThickness) {
    ...
    void drawBackgroundThickLine(int iVirtualX1, int iVirtualY1, int iVirtualX2, int iVirtualY2, unsigned int uiColour,
                                 int iThickness) {
    ...
    void drawForegroundVerticalSidedRegion(
        ...
        m_pForegroundSurface->drawVerticalSidedRegion(fVirtualX1, fVirtualX2, fVirtualY1a, fVirtualY2a, fVirtualY1b,
                                                      fVirtualY2b, uiColour);
    }
    ...
    void drawBackgroundVerticalSidedRegion(
        ...
        double fVirtualY1b, double fVirtualY2b,
        unsigned int uiColour) {
        m_pBackgroundSurface->drawVerticalSidedRegion(fVirtualX1, fVirtualX2, fVirtualY1a, fVirtualY2a, fVirtualY1b,
                                                      fVirtualY2b, uiColour);
    }
    ...
    void drawForegroundTriangle(
        ...
        unsigned int uiColour) {
        m_pForegroundSurface->drawTriangle(iVirtualX1, iVirtualY1, iVirtualX2, iVirtualY2, iVirtualX3, iVirtualY3,
                                           uiColour);
    }
    ...
    void drawBackgroundTriangle(
        ...
        int iVirtualX3, int iVirtualY3,
        unsigned int uiColour) {
        m_pBackgroundSurface->drawTriangle(iVirtualX1, iVirtualY1, iVirtualX2, iVirtualY2, iVirtualX3, iVirtualY3,
                                           uiColour);
    }
    ...
    void drawForegroundRectangle(int iVirtualX1, int iVirtualY1, int iVirtualX2, int iVirtualY2,
                                 unsigned int uiColour) {
    ...
    void drawBackgroundRectangle(int iVirtualX1, int iVirtualY1, int iVirtualX2, int iVirtualY2,
                                 unsigned int uiColour) {
    ...
    void drawForegroundString(int iX, int iY, const char* pText, unsigned int uiColour, Font* pFont = nullptr) {
    ...
    void drawBackgroundString(int iX, int iY, const char* pText, unsigned int uiColour, Font* pFont = nullptr) {
    ...
    */
    void rawSetForegroundPixel(int iRealX, int iRealY, unsigned int uiColour) {
    ...
    These are actual pixel positions on the screen - so make sure that they are in range otherwise you may corrupt memory.
    */
    void rawSetBackgroundPixel(int iRealX, int iRealY, unsigned int uiColour) {
    ...
    unsigned int rawGetForegroundPixel(int iRealPixelX, int iRealPixelY) const {
    ...
    unsigned int rawGetBackgroundPixel(int iRealPixelX, int iRealPixelY) const {
    ...
    */
    static int symbolToKeycode(int iSym) {
        ...
        switch(iSym) {
            case SDLK_UP:
                return SDL12_SDLK_NORMAL + 1;
            case SDLK_DOWN:
                return SDL12_SDLK_NORMAL + 2;
            case SDLK_LEFT:
                return SDL12_SDLK_NORMAL + 3;
            case SDLK_RIGHT:
                return SDL12_SDLK_NORMAL + 4;
            case SDLK_F1:
                return SDL12_SDLK_NORMAL + 5;
            case SDLK_F2:
                return SDL12_SDLK_NORMAL + 6;
            case SDLK_F3:
                return SDL12_SDLK_NORMAL + 7;
            case SDLK_F4:
                return SDL12_SDLK_NORMAL + 8;
            case SDLK_F5:
                return SDL12_SDLK_NORMAL + 9;
            case SDLK_F6:
                return SDL12_SDLK_NORMAL + 10;
            case SDLK_F7:
                return SDL12_SDLK_NORMAL + 11;
            case SDLK_F8:
                return SDL12_SDLK_NORMAL + 12;
            case SDLK_F9:
                return SDL12_SDLK_NORMAL + 13;
            case SDLK_F10:
                return SDL12_SDLK_NORMAL + 14;
            case SDLK_F11:
                return SDL12_SDLK_NORMAL + 15;
            case SDLK_F12:
                return SDL12_SDLK_NORMAL + 16;
            case SDLK_PRINTSCREEN:
                return SDL12_SDLK_NORMAL + 17;
            case SDLK_SCROLLLOCK:
                return SDL12_SDLK_NORMAL + 18;
            case SDLK_PAUSE:
                return SDL12_SDLK_NORMAL + 19;
            case SDLK_INSERT:
                return SDL12_SDLK_NORMAL + 20;
            case SDLK_HOME:
                return SDL12_SDLK_NORMAL + 21;
            case SDLK_PAGEUP:
                return SDL12_SDLK_NORMAL + 22;
            case SDLK_DELETE:
                return SDL12_SDLK_NORMAL + 23;
            case SDLK_END:
                return SDL12_SDLK_NORMAL + 24;
            case SDLK_PAGEDOWN:
                return SDL12_SDLK_NORMAL + 25;
            case SDLK_RETURN:
                return SDL12_SDLK_NORMAL + 26;
            case SDLK_BACKSPACE:
                return SDL12_SDLK_NORMAL + 27;
            case SDLK_ESCAPE:
                return SDL12_SDLK_NORMAL + 28;
            case SDLK_TAB:
                return SDL12_SDLK_NORMAL + 29;
            case SDLK_SPACE:
                return SDL12_SDLK_NORMAL + 30;
            case SDLK_CAPSLOCK:
                return SDL12_SDLK_NORMAL + 31;
            case SDLK_NUMLOCKCLEAR:
                return SDL12_SDLK_NORMAL + 32;
            case SDLK_KP_DIVIDE:
                return SDL12_SDLK_NORMAL + 33;
            case SDLK_KP_MULTIPLY:
                return SDL12_SDLK_NORMAL + 34;
            case SDLK_KP_MINUS:
                return SDL12_SDLK_NORMAL + 35;
            case SDLK_KP_PLUS:
                return SDL12_SDLK_NORMAL + 36;
            case SDLK_KP_ENTER:
                return SDL12_SDLK_NORMAL + 37;
            case SDLK_LCTRL:
                return SDL12_SDLK_NORMAL + 38;
            case SDLK_LSHIFT:
                return SDL12_SDLK_NORMAL + 39;
            case SDLK_LALT:
                return SDL12_SDLK_NORMAL + 40;
            case SDLK_LGUI:
                return SDL12_SDLK_NORMAL + 41;
            case SDLK_RCTRL:
                return SDL12_SDLK_NORMAL + 42;
            case SDLK_RSHIFT:
                return SDL12_SDLK_NORMAL + 43;
            case SDLK_RALT:
                return SDL12_SDLK_NORMAL + 44;
            case SDLK_RGUI:
                return SDL12_SDLK_NORMAL + 45;
        }
    ...
    */
    bool filter(DrawingSurface* surface, int& xReal, int& yReal, unsigned int& uiColour) override {
        ...
        if(m_bNeedsRedraw && !m_bTotalRedraw) {
            if(xReal < m_iRedrawRealLeft || xReal > m_iRedrawRealRight || yReal < m_iRedrawRealTop || yReal >
                m_iRedrawRealBottom)
                return false;
        }
        return true;
...
public:
    ...
    */
    ...
    bool isTimeToAct() const { return m_iTick >= m_iNextTickToActOn; }
    ...
    bool isTimeToActWithSleep() const {
