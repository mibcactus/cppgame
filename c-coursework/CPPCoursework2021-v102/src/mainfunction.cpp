...
/*
#include "Demos/SimpleDemo.h"
#include "Demos/BouncingBallMain.h"
#include "Demos/DemoA.h"
#include "Demos/MazeDemoMain.h"

#include "Demos/FlashingDemo.h"
#include "Demos/StarfieldDemo.h"
#include "Demos/ImageMappingDemo.h"
#include "Demos/ZoomingDemo.h"
#include "Demos/DraggingDemo.h"*/
#include "Psymp12Engine.h"


// These are passed to initialise to determine the window size
const int BaseScreenWidth = 1280;  // 16 tiles
const int BaseScreenHeight = 1024; // 12.8 tiles
